...
class AuthRoutes{
    ...
    public async register(req: Request, res: Response){
        ...
        const newUser = new User({name, age, password: hashed, roles});
        ...
        const token = jwt.sign({id: savedUser._id, name: savedUser.name}, config.SECRET,{
    ...
    public async login(req: Request, res: Response) {
        const userFound = await User.findOne({email: req.body.name}).populate('roles');
